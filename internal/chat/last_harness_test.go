...
func TestCreateSessionPersistsLastHarness(t *testing.T) {
	...
	if _, err := svc.CreateSession(proj.ID, "t", "opencode", false, "", nil); err != nil {
	...
	if _, err := svc.CreateSession(proj.ID, "t", "", false, "", nil); err != nil {
	...
	if _, err := svc.CreateSession(proj.ID, "t", "nope", false, "", nil); err != nil {
