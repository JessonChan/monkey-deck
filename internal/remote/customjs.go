...
// application_server.go, MIT license; see THIRD_PARTY_LICENSES.md), with one
// addition: on (re)connect it dispatches "remote:resync" so the frontend can
// re-pull snapshots — the WS bridge does not replay events missed while
// disconnected (AGENTS.md §1.8).
